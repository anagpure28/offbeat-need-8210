      ...
      <div>
        ...
        <Box
          ...
          <Container as={Stack} maxW={'8xl'} py={10}>
            <SimpleGrid
              templateColumns={{ sm: '1fr 1fr 1fr', md: '2fr 1fr 1fr 2fr', lg: "2fr 2fr 2fr 2fr 2fr 3fr" }}
              spacing={8}>
              <Stack spacing={6}>
                <Box>
                  <Image src="../../../../LiberFM.png" width={"150px"} />
                </Box>
                <Text fontSize={'sm'}>
                  © 2022 LIBER.FM . All rights reserved
                </Text>
              ...
              <Stack align={'flex-start'}>
                <ListHeader>LIBER.FM</ListHeader>
                <Link href={'#'}>Affiliate Program</Link>
                <Link href={'#'}>Bulk Order Discounts</Link>
                <Link href={'#'}>Liber Mobile Apps</Link>
                <Link href={'#'}>Liber Membership</Link>
                <Link href={'#'}>Liber Educations</Link>
                <Link href={'#'}>Liber Kid's Club</Link>
                <Link href={'#'}>Liber Bookfairs</Link>
              </Stack>
              <Stack align={'flex-start'}>
                <ListHeader>ABOUT US</ListHeader>
                <Link href={'#'}>About LIBER</Link>
                <Link href={'#'}>Careers at LIBER</Link>
                <Link href={'#'}>Liber & Noble, Inc</Link>
                <Link href={'#'}>Privacy Policy</Link>
                <Link href={'#'}>Liber Kitchen</Link>
              </Stack>
              <Stack align={'flex-start'}>
                <ListHeader>QUICK HELP</ListHeader>
                <Link href={'#'}>Help Center</Link>
                <Link href={'#'}>Covid Safety</Link>
              ...
              <Stack align={'flex-start'}>
                ...
                <Link href={'#'}>Holiday Gift Guide</Link>
              </Stack>
              <Box>
              <Stack align={'flex-start'} style={{marginTop:"10px"}}>
                <Text fontSize={"sm"} fontWeight={"500"} textAlign={"left"} marginTop={"10px"}>FIND A STORE</Text>
                <Stack direction={'row'}>
                  <Input
                    placeholder={'Store name, location, or Zip Code'}
                    bg={useColorModeValue('blackAlpha.100', 'whiteAlpha.100')}
                    border={0}
                    _focus={{
                      bg: 'whiteAlpha.300',
                  ...
                  />
                  <IconButton
                    bg={useColorModeValue('#A0AEC0', '#718096')}
              ...
              <Stack align={'flex-start'} style={{marginTop:"10px"}}>
                <Text fontSize={"sm"} fontWeight={"500"} textAlign={"left"} marginTop={"10px"}>SIGN UP FOR SAVINGS, NEWS, AND UPDATES</Text>
                <Stack direction={'row'}>
                  <Input
